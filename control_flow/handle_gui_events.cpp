      ...
      switch (event.type)
        ...
        case sf::Event::EventType::KeyPressed:
          ...
          if (event.key.code == sf::Keyboard::Key::Right)
            result.push_back (request_player_action (std::make_unique<rotate_action> (2.f, 0.f)));
          if (event.key.code == sf::Keyboard::Key::Left)
            result.push_back (request_player_action (std::make_unique<rotate_action> (-2.f, 0.f)));
          if (event.key.code == sf::Keyboard::Key::Up)
            result.push_back (request_player_action (std::make_unique<rotate_action> (0.f, 2.f)));
